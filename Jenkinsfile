				...
				script
     {
      ...
      rtMaven.run pom: 'pom.xml', goals: 'clean install', buildInfo: buildInfo
	    ...
	    stage('Download Files') {
            steps {
		    sh 'scp scm_admin@10.127.128.200 /home/scm_admin/architecture_builder_scripts/padding.css root@10.127.127.203:/data/admin/jenkins/.jenkins/workspace/CI_Infrastructure_Verification'
